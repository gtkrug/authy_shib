...
public class AuthyTwoFactorLoginHandlerBeanDefinitionParser extends AbstractLoginHandlerBeanDefinitionParser {

    /** Schema type. */
    public static final QName SCHEMA_TYPE = new QName(AuthyTwoFactorLoginNamespaceHandler.NAMESPACE, "AuthyTwoFactorLogin");

    /** Class logger. */
    private final Logger log = LoggerFactory.getLogger(AuthyTwoFactorLoginHandlerBeanDefinitionParser.class);

    /** {@inheritDoc} */
    protected Class getBeanClass(Element element) {
        return AuthyTwoFactorLoginHandlerFactoryBean.class;
    }
